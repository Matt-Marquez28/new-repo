...
const AccountStatistics = () => {
  ...
  return (
    <section
      className="stats-section py-5 my-5"
      style={{
        borderRadius: "0",
        position: "relative",
        overflow: "hidden",
              ...
              >
                ...
                <div className="position-relative" style={{ zIndex: "2" }}>
                  ...
                  <p className="text-muted">
                    Talented professionals looking for their next opportunity
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="position-relative" style={{ zIndex: "2" }}>
                  ...
                  >
                    <i
                      ...
                      style={{ fontSize: "2.5rem", color: "#2ecc71" }}
                    ></i>
                  </div>
                  <h3
                    className="counter-value mb-0"
                  ...
                  ></div>
                  <p className="text-muted">
                    Companies searching for the perfect candidates
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="position-relative" style={{ zIndex: "2" }}>
                  ...
                  >
                    <i
                      ...
                      style={{ fontSize: "2.5rem", color: "#9b59b6" }}
                    ></i>
                  </div>
                  <h3
                    className="counter-value mb-0"
                  ...
                  ></div>
                  <p className="text-muted">
                    Active members engaged on our platform daily
                  </p>
                </div>
              </div>
            </div>
